...
public class Funcionario {
    ...
    private String verificarAcesso;
    ...
    public Funcionario(String id, String nome, String senha, String cpf, String email, String telefone, String genero,
            String endereco, String dataNasc, String cargo, String salario, String dataAdms, String verificarAcesso) {
        super();
        this.id = id;
        this.nome = nome;
        this.senha = senha;
    ...
    public String getVerificarAcesso() {
        return verificarAcesso;
    }
    public void setVerificarAcesso(String verificarAcesso) {
        this.verificarAcesso = verificarAcesso;
    }
}
