...
public class controllerCardapio implements Initializable {
    ...
    @FXML private TableColumn<Cardapio, String> columnIndice;
    @FXML private TableColumn<Cardapio, String> columnNome;
    @FXML private TableColumn<Cardapio, String> columnDescricao;
    @FXML private TableColumn<Cardapio, String> columnCategoria;
    @FXML private TableColumn<Cardapio, String> columnPrecoUN;
    @FXML private TableView<Cardapio> tableCardapio;
